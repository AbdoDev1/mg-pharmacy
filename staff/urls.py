...
from staff.views import dashboard, inventory, clients, products, orders, prescriptions, accounting, employees, account_types, reports, tags, activity, followups, backup, returns, studio
...
urlpatterns = [
    ...
    path('products/import/confirm/status/', products.import_products_commit_status, name='import_products_commit_status'),
    path('products/import/confirm/result/', products.import_products_commit_result, name='import_products_commit_result'),
    ...
    path('products/export/processing/', products.export_products_processing, name='export_products_processing'),
    path('products/export/download/<str:token>/', products.export_products_download, name='export_products_download'),
    ...
    path('orders/prescriptions/<int:pk>/', prescriptions.prescription_detail, name='prescription_detail'),
    ...
    path('reports/products/filter-search/', reports.report_product_search, name='reports_product_search'),
    path('reports/clients/filter-search/', reports.report_client_search, name='reports_client_search'),
    ...
    path('reports/export/download/<str:token>/', reports.reports_export_download, name='reports_export_download'),
